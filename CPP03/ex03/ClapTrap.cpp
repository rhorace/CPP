...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/06/17 14:56:38 by rhorace           #+#    #+#             */
/*   Updated: 2026/06/18 16:42:42 by rhorace          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::attack(const std::string &target)
{
	...
	{
		std::cout << RED << "ClapTrap: " << this->_name << "[" << this << "] cannot attack; he does not have enough energy or hit points." << RESET << std::endl;
	}
}
